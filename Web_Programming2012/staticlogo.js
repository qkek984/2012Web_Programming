...
var ddsitelogo={
	setting: {orientation:4, visibleduration:0, fadeduration:[500, 300]}, //orientation=1|2|3|4, duration=millisec or 0, fadedurations=millisecs
	offsets: {x:10, y:10},//offset of logo relative to window corner
	logoHTML: '<a href="#top" title="link it to the top"><img src="http://abluesea.wo.to/wp/hansung.GIF" style="width:50px; height:47px; border:0" /></a>', //HTML for logo, which is auto wrapped in DIV w/ ID="mysitelogo"
